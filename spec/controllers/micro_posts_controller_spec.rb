...
describe MicroPostsController do
  ...
  let(:valid_attributes) { { "micro_post" => "MyText" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved micro_post as @micro_post" do
        ...
        post :create, {:micro_post => { "micro_post" => "invalid value" }}, valid_session
        assigns(:micro_post).should be_a_new(MicroPost)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested micro_post" do
        ...
        MicroPost.any_instance.should_receive(:update).with({ "micro_post" => "MyText" })
        put :update, {:id => micro_post.to_param, :micro_post => { "micro_post" => "MyText" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the micro_post as @micro_post" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        MicroPost.any_instance.stub(:save).and_return(false)
        put :update, {:id => micro_post.to_param, :micro_post => { "micro_post" => "invalid value" }}, valid_session
        assigns(:micro_post).should eq(micro_post)
      end
